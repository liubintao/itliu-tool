...
import com.robust.tools.kit.lang.JarClassLoader;
...
public class ClassLoaderUtil {
     ...
     * @param name 类名
     * @return 类名对应的类
     * @throws UnCheckedException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(String name) throws UnCheckedException {
     ...
     * @throws UnCheckedException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(String name, boolean isInitialized) throws UnCheckedException {
     ...
     * @throws UnCheckedException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(String name, ClassLoader classLoader, boolean isInitialized) throws UnCheckedException {
     ...
     *
     * @param dir jar文件或者包含jar和class文件的目录
     * @return {@link JarClassLoader}
     * @since 1.0
     */
    public static JarClassLoader getJarClassLoader(File dir) {
        return JarClassLoader.load(dir);
    }
