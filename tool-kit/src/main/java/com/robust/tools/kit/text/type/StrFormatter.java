package com.robust.tools.kit.text.type;
...
public class StrFormatter {
	...
	public static String format(final String strPattern, final Object... argArray) {
		...
		for (int argIndex = 0; argIndex < argArray.length; argIndex++) {
			...
			// 转义符
			if (delimIndex > 0 && strPattern.charAt(delimIndex - 1) == Platforms.WINDOWS_FILE_PATH_SEPARATOR_CHAR) {// 转义符
				if (delimIndex > 1 && strPattern.charAt(delimIndex - 2) == Platforms.WINDOWS_FILE_PATH_SEPARATOR_CHAR) {// 双转义符
