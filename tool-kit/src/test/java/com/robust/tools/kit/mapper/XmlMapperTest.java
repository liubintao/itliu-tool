...
public class XmlMapperTest {
    ...
    public void xml2Object() {
        ...
        assertThat(user.getName()).isEqualTo("zh");
        assertThat(user.getInterests()).containsExactly("movie","sports");
    }
    ...
    private static String generateXmlByDom4j() {
        ...
        Element rootElement = document.addElement("user").addAttribute("id", "1");
        rootElement.addElement("name").setText("zh");

        Element interests = rootElement.addElement("interests");
        interests.addElement("interest").setText("movie");
        interests.addElement("interest").setText("sports");
    ...
    private static void assertXmlByDom4j(String xml) {
        ...
        assertThat((interests.elements().get(0)).getText()).isEqualTo("movie");
    }
